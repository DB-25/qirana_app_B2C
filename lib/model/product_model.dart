class ProductModel {
  ...
  ProductModel(
      ...
      this.description,
      this.url,
      this.discount,this.retailPrice,this.wholesalePrice,this.mrp,
      this.imageOne,
      this.imageTwo,
      this.price,
      this.status,
  ...
  factory ProductModel.fromMap(Map<String, dynamic> map) {
    return ProductModel(
      ...
      retailPrice: map.containsKey('retailPrice') ? (map['retailPrice'] ?? '') : 0.0,
      wholesalePrice: map.containsKey('wholesalePrice') ? (map['wholesalePrice'] ?? '') : 0.0,
      mrp: map.containsKey('mrp') ? (map['mrp'] ?? '') : 0.0,
